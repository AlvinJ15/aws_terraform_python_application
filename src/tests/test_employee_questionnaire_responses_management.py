...
EXPECTED_JSON_PATH = f'{BASE_JSON_FOLDER}/expected/employee_questionnaire_responses_management'
BODY_JSON_FOLDER = f'{BASE_JSON_FOLDER}/body_request/employee_questionnaire_responses_management'
...
class TestEmployees:
    def setup_method(self, method):
        from api_services.employee_questionnaire_responses.employee_questionnaire_responses_management import (
    ...
    def test_get_single_handler(self, initialize_db):
        event = {
            "pathParameters": {
                "organization_id": "11111111-1111-1111-1111-111111111111",
                "employee_id": "xxxxxxx-aaaa-aaaa-aaaa-aaaaaaaaaaaa",
                "response_id": "xxxxxxx-xxxx-aaaa-aaaa-aaaaaaaaaaaa"
            }
        }
    ...
    def test_delete_handler(self, initialize_db):
        event = {
            "pathParameters": {
                ...
                "response_id": "xxxxxxx-xxxx-bbbb-bbbb-bbbbbbbbbbbb"
            }
        }
