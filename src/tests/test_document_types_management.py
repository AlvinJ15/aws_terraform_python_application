...
EXPECTED_JSON_PATH = f'{BASE_JSON_FOLDER}/expected/document_types_management'
BODY_JSON_FOLDER = f'{BASE_JSON_FOLDER}/body_request/document_types_management'
...
class TestRDocumentTypes:
    def setup_method(self, method):
        from api_services.document_types.document_types_management import (
