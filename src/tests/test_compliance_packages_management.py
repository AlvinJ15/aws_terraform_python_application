...
EXPECTED_JSON_PATH = f'{BASE_JSON_FOLDER}/expected/compliance_packages_management'
BODY_JSON_FOLDER = f'{BASE_JSON_FOLDER}/body_request/compliance_packages_management'
...
class TestCompliancePackages:
    def setup_method(self, method):
        from api_services.compliance_packages.compliance_packages_management import (
    ...
    def test_get_single_handler(self, initialize_db):
        event = {
            "pathParameters": {
                ...
                "package_id": "wwwwwwww-bbbb-bbbb-bbbb-bbbbbbbbbbbb"
            }
        }
    ...
    def test_update_handler(self, initialize_db):
        ...
        event = {
            "pathParameters": {
                "organization_id": "11111111-1111-1111-1111-111111111111",
                "package_id": "zzzzzzzz-aaaa-aaaa-aaaa-aaaaaaaaaaaa"
            },
    ...
    def test_delete_handler(self, initialize_db):
        event = {
            "pathParameters": {
                "organization_id": "11111111-1111-1111-1111-111111111111",
                "package_id": "yyyyyyyy-bbbb-bbbb-bbbb-bbbbbbbbbbbb"
            }
        }
