locals {
  ...
  methods_names = {
    get_all_employee_documents = {
      lambda_name = "GetAllEmployeeDocuments"
    ...
    get_single_employee_documents = {
      lambda_name = "GetSingleEmployeeDocuments"
    ...
    create_employee_documents = {
      lambda_name = "CreateEmployeeDocuments"
    ...
    update_employee_documents = {
      lambda_name = "UpdateEmployeeDocuments"
    ...
    delete_single_employee_documents = {
      lambda_name = "DeleteSingleEmployeeDocuments"
...
module "employee_documents_cors" {
