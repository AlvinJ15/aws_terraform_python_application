locals {
  ...
  methods_names = {
    ...
    get_single_employees = {
      lambda_name = "GetSingleEmployees"
    ...
    delete_single_employees = {
      lambda_name = "DeleteSingleEmployees"
