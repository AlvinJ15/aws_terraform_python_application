locals {
  ...
  methods_names = {
    get_all_compliance_packages = {
      lambda_name = "GetAllCompliancePackages"
    ...
    get_single_compliance_packages = {
      lambda_name = "GetSingleCompliancePackages"
    ...
    create_compliance_packages = {
      lambda_name = "CreateCompliancePackages"
    ...
    update_compliance_packages = {
      lambda_name = "UpdateCompliancePackages"
    ...
    delete_compliance_packages = {
      lambda_name = "DeleteCompliancePackages"
...
module "compliance_packages_cors" {
