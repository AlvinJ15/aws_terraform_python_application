locals {
  ...
  methods_names = {
    get_all_questionnaires = {
      lambda_name = "GetAllQuestionnaires"
    ...
    get_single_questionnaires = {
      lambda_name = "GetSingleQuestionnaires"
    ...
    create_questionnaires = {
      lambda_name = "CreateQuestionnaires"
    ...
    update_questionnaires = {
      lambda_name = "UpdateQuestionnaires"
    ...
    delete_single_questionnaires = {
      lambda_name = "DeleteSingleQuestionnaires"
