...
import {Row, Col, Form, FormGroup, Label, Input, Accordion, AccordionBody, AccordionHeader, AccordionItem, UncontrolledAccordion, Card, CardHeader, Spinner } from 'reactstrap';

import ProfileOff from './ProfileOff';

import organizationService from '../organization/services/organization.service';
import DetailAdapter from './adapter/Detail.adapter';
    ...
    return (
        <>
            ...
            <ProfileOff>
                <Card className='p-4'>
                    <CardBody>
                        <h4>Customize the personal info below</h4>
                    </CardBody>
                    <hr></hr>
                    <CardBody>
                        {
                                    ...
                                    <AccordionItem>
                                        ...
                                        <AccordionBody className='bg-white' accordionId="1">
                                            <Form className='p-4'>
                                                <FormGroup>
                                                    <Label>Gender</Label>
                                                    <Input type="text" placeholder="Enter a gender" name="gender" value={profile.gender} onChange={handleInput}/>
                                                </FormGroup>
                                                <FormGroup>
                                                    <Label>Title</Label>
